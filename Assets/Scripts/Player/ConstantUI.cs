...
public class ConstantUI : MonoBehaviour
{
    ...
    [SerializeField] private Scrollbar sliderHealth;
    [SerializeField] private Text energy;
    [SerializeField] private Scrollbar sliderEnergy;
    [SerializeField] private Button buttonSkills;
    [SerializeField] private Button buttonInventory;
    [SerializeField] private Button buttonQuests;
    [SerializeField] private Button buttonDroids;
    [SerializeField] private Text kredits;
